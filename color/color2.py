...
def main():
    ...
    #print('{} fname.white {}'.crayons.lname.blue('blue'))) # format string (old ver of str templating)
    print(f"{crayons.red('Wale')} {crayons.blue('Salami')}")  # f-string (newest version of str templating)
